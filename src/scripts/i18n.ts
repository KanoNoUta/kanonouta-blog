...
const languages: Record<LanguageKey, LanguagePack> = {
	zh: {
		...
		text: {
			...
			'post.thief-neko-protocol-gateway-devlog.title': '从 500 次额度到协议网关：Thief Neko 开发笔记',
			'post.thief-neko-protocol-gateway-devlog.description': '把 Catpaw 的 GLM-5.2 接入 Claude Code 与 Codex：从协议转换、工具调用和 SSE，到凭证刷新与长会话治理。',
			'post.thief-neko-protocol-gateway-devlog.pageTitle': '从 500 次额度到协议网关：Thief Neko 开发笔记 - Kano no Uta',
			'post.webtimeline-development-diary.title': '把 ACR 时间轴搬进浏览器：WebTimeline 开发日记',
			'post.webtimeline-development-diary.description': '从一份难以维护的时间轴 JSON，到一个能浏览、导入、编辑、校验并重新导出的可视化工作台。',
			'post.webtimeline-development-diary.pageTitle': '把 ACR 时间轴搬进浏览器：WebTimeline 开发日记 - Kano no Uta',
		},
		mapNames: {},
		mapRegions: {},
		mapNotes: {},
	...
	ja: {
		...
		text: {
			...
			'post.thief-neko-protocol-gateway-devlog.title': '500 回分の枠からプロトコルゲートウェイへ：Thief Neko 開発ノート',
			'post.thief-neko-protocol-gateway-devlog.description': 'Catpaw の GLM-5.2 を Claude Code と Codex へ接続するまで。プロトコル変換、ツール呼び出し、SSE、認証情報の更新、長時間セッション管理を解説します。',
			'post.thief-neko-protocol-gateway-devlog.pageTitle': '500 回分の枠からプロトコルゲートウェイへ：Thief Neko 開発ノート - Kano no Uta',
			'post.webtimeline-development-diary.title': 'ACR タイムラインをブラウザへ：WebTimeline 開発日記',
			'post.webtimeline-development-diary.description': '保守しづらいタイムライン JSON から、閲覧・インポート・編集・検証・再エクスポートまでできる可視化ワークベンチへ。',
			'post.webtimeline-development-diary.pageTitle': 'ACR タイムラインをブラウザへ：WebTimeline 開発日記 - Kano no Uta',
		},
		mapNames: {
			北京: '北京',
			陕西: '陝西',
	...
	en: {
		...
		text: {
			...
			'post.thief-neko-protocol-gateway-devlog.title': 'From 500 Calls to a Protocol Gateway: Building Thief Neko',
			'post.thief-neko-protocol-gateway-devlog.description': 'How I connected Catpaw\'s GLM-5.2 to Claude Code and Codex, covering protocol conversion, tool calls, SSE, credential refresh, and long-running sessions.',
			'post.thief-neko-protocol-gateway-devlog.pageTitle': 'From 500 Calls to a Protocol Gateway: Building Thief Neko - Kano no Uta',
			'post.webtimeline-development-diary.title': 'Bringing ACR Timelines to the Browser: A WebTimeline Devlog',
			'post.webtimeline-development-diary.description': 'From hard-to-maintain timeline JSON to a visual workspace that can browse, import, edit, validate, and export it again.',
			'post.webtimeline-development-diary.pageTitle': 'Bringing ACR Timelines to the Browser: A WebTimeline Devlog - Kano no Uta',
		},
		mapNames: {
			北京: 'Beijing',
			陕西: 'Shaanxi',
